...
<template>
    <div class="container mx-auto space-y-4">
        ...
        <p class="text-sm text-gray-600">Create a main category, or choose Add subcategory beside an existing one. Each addition saves immediately and appears in the Shop menu when visible.</p>
        ...
        <template v-else>
            ...
            <ContentCategoryForm :content="content" @saved="saved" @cancel="load" />
        </template>
    </div>
</template>
