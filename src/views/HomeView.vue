...
.homepage-flow{display:flex;flex-direction:column}
...
@media(max-width:520px){.category-section{max-width:none;padding:32px 0 36px;overflow:hidden}.compact-heading{text-align:left;margin-bottom:20px;padding:0 18px}.compact-heading h2{font-size:30px}.category-row{display:flex;justify-content:flex-start;gap:14px;padding:0 18px 10px;overflow-x:auto;scroll-snap-type:x mandatory;scroll-padding-inline:18px;-webkit-overflow-scrolling:touch}.category-row::-webkit-scrollbar{display:none}.category-row a{flex:0 0 96px;gap:9px;scroll-snap-align:start;font-size:14px;line-height:1.2;text-align:center;white-space:normal}.category-image{width:88px;height:88px;flex:0 0 88px;border:1px solid #ebe4da;box-shadow:0 5px 16px rgba(53,44,34,.07)}.collections{padding:62px 0 68px}.collections .section-heading{display:block;padding:0 18px;margin-bottom:28px}.section-heading>a{display:inline-block;margin-top:16px}.collection-grid{display:flex;gap:14px;padding:0 18px 8px;overflow-x:auto;scroll-snap-type:x mandatory}.collection-card{flex:0 0 82vw;scroll-snap-align:start;aspect-ratio:4/5}.collection-grid::-webkit-scrollbar{display:none}.gift-copy{padding:50px 22px}.gift-copy h2{font-size:38px}.gift-image{min-height:250px;max-height:290px}.reviews{padding:62px 12px}.review-heading{margin-bottom:30px}.review-heading h2{font-size:38px}.review-carousel{padding:0 28px}.review-grid article{min-height:330px;padding:28px 24px}}
</style>
